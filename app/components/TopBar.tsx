...
export default function TopBar() {
  return (
    <div className="bg-black text-white text-sm font-sans">
      <div className="mx-auto max-w-[1280px] px-6 md:px-12 lg:px-20 flex items-center justify-between h-10">
        {/* Contact */}
        <div className="flex items-center gap-6">
          ...
          >
            <Phone size={13} />
            <span className="hidden sm:inline">9851323800</span>
          </a>
          <a
          ...
          >
            <Mail size={13} />
            <span className="hidden sm:inline">info@thebrandghar.com</span>
          </a>
        </div>
