        ...
        <div className="mx-auto max-w-[1280px] px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              >
                We create powerful visual identities that make your brand
                memorable, consistent, and impossible to ignore.
              </motion.p>
              <motion.p
                {...fadeUp}
              ...
              >
                Brand Identity is how your business looks, feels, and
                communicates visually — from logo and colors to typography and
                design style. It&apos;s what makes your brand recognizable and
                trusted.
              </motion.p>
              <motion.div
                {...fadeUp}
            ...
            >
              <div className="relative aspect-[4/3] rounded-[16px] overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-border">
                <Image
                  src="/medias/illustrations/graphics.jpg"
                  alt="Brand Identity & Graphics Design"
                  fill
