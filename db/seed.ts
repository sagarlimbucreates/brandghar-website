...
const MENU_SEED: Array<{
  ...
  { key: "leads", label: "Leads", href: "#", icon: "UsersRound", requiredGroup: null, sortOrder: 40, parentKey: null },
  { key: "leads_quotes", label: "Get a Quote", href: "/dashboard/leads/quotes", icon: "MessageSquareQuote", requiredGroup: "lead", sortOrder: 10, parentKey: "leads" },
  { key: "leads_consultations", label: "Free Consultation", href: "/dashboard/leads/consultations", icon: "Handshake", requiredGroup: "lead", sortOrder: 20, parentKey: "leads" },
  { key: "leads_contact", label: "Contact Us", href: "/dashboard/leads/contact-us", icon: "Mail", requiredGroup: "lead", sortOrder: 30, parentKey: "leads" },
